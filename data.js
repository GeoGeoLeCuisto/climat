...
/* ---------------------------------------------------------------------
   ...
   les françaises — c'est un choix de qualité sonore, pas de contenu.
   ------------------------------------------------------------------- */
export const NARRATIONS_EN = {
  hadeen: [
    "There are no continents yet. No oceans. No blue sky.",
    "Four billion five hundred and forty million years ago, the Earth is a ball of molten rock, struck again and again by the debris of its own birth.",
    "Then a world the size of Mars collides with it. From that collision, the Moon will be born.",
    "The Sun, at this time, shines with only seventy percent of its present power. The Earth should have been a frozen desert.",
    "It is not. Because its atmosphere is saturated with carbon dioxide, and that gas holds heat.",
    "Remember this. The gas that made the Earth habitable is the very same one we will be talking about until the end of this story.",
  ],
  archeen: [
    "The rock has cooled. The water is here. And in that water, something begins.",
    "Three and a half billion years ago, colonies of microbes are building domes of limestone at the edge of shallow lagoons. They are the oldest traces of life we know how to read.",
    "The air is unbreathable. No oxygen. Carbon dioxide, methane, nitrogen.",
    "And during all this time, with no one deciding it, a mechanism falls into place. Rain attacks the rock. The rock captures carbon. The carbon sinks to the bottom of the oceans.",
    "When the Earth grows too warm, this mechanism speeds up and cools it. When it grows too cold, it slows down and lets the planet warm.",
    "A thermostat. A real one. It is still running today.",
    "But it needs a hundred thousand years to respond. Remember that number.",
  ],
  goe: [
    "The microbes have learned to feed on light. And they release a waste product.",
    "That waste product is oxygen.",
    "For hundreds of millions of years, the iron dissolved in the ocean devours it, rusting on the seafloor. Those rusts are our iron mines today.",
    "Then, two billion four hundred million years ago, the ocean saturates. Oxygen rises into the sky.",
    "And it destroys methane. The greenhouse effect collapses.",
    "The planet freezes. For a long time.",
    "A form of life had just altered the atmosphere of the entire world, and overturned its climate.",
    "It was only the first time.",
  ],
  snowball: [
    "Seven hundred and twenty million years ago, the ice comes down.",
    "It leaves the poles. It takes the middle latitudes. It reaches the tropics.",
    "The more the ice spreads, the more sunlight it reflects back to space. The more light it reflects, the colder it gets. The colder it gets, the more the ice spreads.",
    "The Earth tips over. It turns white.",
    "And beneath that shell, the thermostat is unplugged. Rain can no longer attack the rock. Carbon can no longer be captured.",
    "But the volcanoes have not stopped. For millions of years, they fill the sky with carbon dioxide.",
    "Until the heat returns, and melts an entire world.",
    "The Earth knows how to repair itself. But it takes its time. And it does not ask our opinion.",
  ],
  paleozoique: [
    "Life leaves the water.",
    "First mats. Then stems. Then roots. Then wood. In a hundred million years, the continents turn from grey to green.",
    "And those roots do something enormous. They break the rock. They offer the rain an immense surface to attack. Carbon is captured faster than it is emitted.",
    "Carbon dioxide collapses. From several thousand parts per million, it falls to a few hundred.",
    "The world cools.",
    "This is not a catastrophe. It is simply the forest taking control of the thermostat.",
    "It took fifty million years.",
  ],
  carbonifere: [
    "Look at these swamps.",
    "Ferns thirty metres tall. Dragonflies with a seventy centimetre wingspan. Air loaded with more than thirty percent oxygen.",
    "Every tree that falls into the water does not fully rot. It sinks. It compacts. It transforms.",
    "For sixty million years, this forest buries carbon. Billions upon billions of tonnes.",
    "That carbon has a name. We call it coal.",
    "Beneath your feet, in the Sambre and Meuse valley, in the Ruhr, in Wales, it is still there.",
    "And here is what must be understood. What life took sixty million years to remove from the air, we are giving back in two centuries.",
  ],
  permien: [
    "Two hundred and fifty two million years ago, Siberia opens.",
    "Not one eruption. A million years of eruptions. Millions of cubic kilometres of lava, which pass on their way through ancient coal basins, and burn them.",
    "Carbon dioxide floods the atmosphere. Temperature rises by eight, perhaps ten degrees.",
    "The oceans acidify. Then they lose their oxygen. Then they fall silent.",
    "Eighty one percent of marine species disappear. Life will take millions of years to recover.",
    "Geologists call it the Great Dying.",
    "Carbon, heat, acid, suffocation. This chain of events is not a theory. It has already happened.",
  ],
  cretace: [
    "Forget the polar ice caps. There are none.",
    "A hundred million years ago, forests grow beyond the Arctic Circle. Crocodilians swim where the sea ice will be.",
    "Carbon dioxide is perhaps four times more abundant than today.",
    "And with no ice on the continents, all that water is in the oceans. Sea level is one hundred, two hundred metres higher. Inland seas cross North America, Europe and Africa.",
    "This is not a dead world. It is a lush one.",
    "But lay a map of our cities over this one. And ask yourself where they would be.",
  ],
  kpg: [
    "An object ten kilometres across. Twenty kilometres per second.",
    "It strikes the Earth off the Yucatán peninsula.",
    "First, fire. Then dust and sulphur rise into the stratosphere and veil the Sun. Photosynthesis stops. The cold settles in for a few years.",
    "Three species out of four disappear. The non-avian dinosaurs do not survive it.",
    "Then the dust falls back. And the carbon dioxide released by the impact remains.",
    "The world warms for tens of thousands of years.",
    "A handful of aerosols cools for a few seasons. Carbon warms for millennia.",
    "That is the whole difference between a pollution and a climate.",
  ],
  petm: [
    "Here is the event that should concern us more than all the others.",
    "Fifty six million years ago, between three thousand and seven thousand billion tonnes of carbon enter the atmosphere and the ocean.",
    "The planet gains five to eight degrees. The oceans acidify to the point of dissolving limestone on the seafloor. Species flee toward the poles.",
    "Geologists read this event as a rupture. They call it the Paleocene-Eocene Thermal Maximum.",
    "Now, the speed.",
    "That carbon was injected over three thousand to twenty thousand years. One billion tonnes per year, at most.",
    "We emit more than ten billion tonnes per year today.",
    "Ten times faster. At least.",
    "The life of the Paleocene had millennia to move. We are giving ours a few decades.",
    "And the return to equilibrium, back then, took a hundred and fifty thousand years.",
  ],
  cenozoique: [
    "The world cools.",
    "India slams into Asia and lifts the Himalayas. New mountains, fresh rock, rain. Carbon is captured, year after year, for fifty million years.",
  ...
  quaternaire: [
    "For two million six hundred thousand years, the Earth has been breathing.",
    "A hundred thousand years of ice. Then ten thousand years of warmth. Then the ice returns.",
    "This rhythm is no accident. It is the Earth's orbit. It stretches, the axis tilts, it wobbles. Sunlight is redistributed between the seasons and the latitudes.",
    "But these variations are far too weak to move the climate by five degrees.",
    "So the ice of Antarctica gives us the answer. In every trapped bubble of air, carbon dioxide rises and falls with temperature. One hundred and eighty parts per million during the glaciations. Two hundred and eighty during the warm periods.",
    "Never above. Not once in eight hundred thousand years.",
    "And twenty one thousand years ago, at the coldest. Five degrees below today. Three kilometres of ice over Canada. Sea level a hundred and twenty metres lower. You could walk from Belgium to England.",
    "Five degrees. Remember what five degrees means.",
  ],
  holocene: [
    "Eleven thousand seven hundred years ago, the ice withdraws. And something extraordinary begins.",
    "Nothing.",
    "Nothing happens. For eleven thousand years, the global temperature barely moves. Half a degree either way, at most.",
    "It is in this calm that we sowed the first grain. Built the first city. Wrote the first word. Drew the first borders.",
    "Every port, every field, every inhabited delta was chosen to suit that climate.",
    "We have never known anything else.",
    "Our entire civilisation fits inside a parenthesis of stability.",
  ],
  industrie: [
    "Seventeen sixty nine. James Watt files his patent.",
    "Carboniferous coal comes back to the surface. And with it, carbon buried for three hundred million years.",
    "And here is what few people know.",
    "Eighteen twenty four. Joseph Fourier understands that the atmosphere holds heat.",
    "Eighteen fifty six. Eunice Foote places a flask of carbon dioxide rich air in the sunlight, and measures that it warms more.",
    "Eighteen fifty nine. John Tyndall measures that absorption precisely.",
    "Eighteen ninety six. Svante Arrhenius calculates, by hand, that doubling carbon dioxide would warm the Earth by five to six degrees.",
    "Today's science, with its satellites and supercomputers, answers three degrees, between two and a half and four.",
    "Arrhenius was a little high. He was not far off.",
    "We have known for a hundred and thirty years.",
  ],
  acceleration: [
    "After nineteen forty five, everything accelerates at once. Population. Energy. Roads. Fertiliser. Trade.",
    "In nineteen fifty eight, a man installs an instrument at the summit of a Hawaiian volcano. His name is Charles David Keeling. He simply wants to know how much carbon dioxide there is in the air.",
    "The first full year gives three hundred and sixteen parts per million.",
    "His curve rises and falls with the seasons. That is the breathing of the northern hemisphere's forests.",
    "And it rises. Every year. Without exception.",
    "In nineteen seventy nine, the American Academy of Sciences delivers a report. Doubling carbon dioxide would warm the planet by about three degrees.",
    "Forty five years later, that number has not moved.",
  ],
  moderne: [
    "Three hundred and fifty four parts per million in nineteen ninety. Four hundred and twenty five today.",
    "In between. Rio. Kyoto. Paris. Thirty global conferences. Thousands of pages.",
    "And thirty seven billion tonnes of carbon dioxide released every year by fossil fuels. More than ever.",
    "Twenty twenty four was the warmest year ever measured. One point five five degrees above pre-industrial.",
    "The ten warmest years in the entire history of measurement are the last ten.",
    "And all this time, the ocean absorbs. Ninety one percent of the excess heat has gone into it.",
    "What we feel in the air is not even three percent of what is actually happening.",
  ],
  futur: [
    "Here, the story stops. Because what comes next is not written yet.",
    "What physics tells us is simple. Almost brutally simple. Temperature rises in proportion to the total carbon we will have emitted. About half a degree per thousand billion tonnes.",
    "Which means three things.",
    "First. Warming stops, more or less, when our net emissions reach zero. Not fifty years later. When we stop.",
    "Second. Every tonne counts. There is no threshold beyond which it becomes too late to act. There are only thresholds beyond which some damage will never be repaired.",
    "Third. The gap between a two degree world and a three degree world is not a question of physics. It is a question of decisions.",
    "Four and a half billion years have brought us here.",
    "What comes next fits inside the next few decades.",
    "And that, for the first time in this entire story, depends on a single species.",
  ],
};
